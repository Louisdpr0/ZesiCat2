...
global.sig = 'https://instagram.com/ksr.cloud' //Link Instagrammu
global.sgh = 'https://github.com/Rencai000' //Link Githubmu
global.sgc = '-'
global.sdc = '-' //Isi Pake Link Discordmu Kalo Gada Biarin aja
global.snh = '-' //Hmmm, Ini boleh kalian isi terserah :v

/*============== PAYMENT ==============*/
global.pdana = '089653898291' //Nomor Danamu
global.ppulsa = '089653898291' //Nomor SimCard Yang Kamu Pake
global.psaweria = '-' //Link Saweriamu Kalo Nggada Ketik - aja

/*============== NOMOR ==============*/
global.nomorbot = '6281319755301' //Nomor Bot
global.nomorown = '6289653898291' //Nomor Owner
global.namebot = 'ZeniCat BOT' //Nama Bot
global.nameown = 'KSR CLOUD' // Nama Owner


/*============== STAFF ==============*/
global.owner = [
  ['6289653818291', 'KSR CLOUD', true] //Ganti jd nomormu sama Namamu
...
/*============== WATERMARK ==============*/
global.wm = '                「 ZENI CAT BOT  」' //Main Watermark
global.wm2 = 'ZENI BOT'
global.wm3 = '⫹⫺ ZENI BOT'
global.namedoc = 'ZENI BOT' //Main Name Menu Document
global.botdate = `⫹⫺ Day's: ${week} ${date}`
global.bottime = `ᴛɪᴍᴇ: ${wktuwib}`
global.titlebot = '🎋 ┊ ZENI BOT ʙᴏᴛ ᴡʜᴀᴛsᴀᴘᴘ'
global.author = global.wm


/*============== LOGO ==============*/
global.thumb = 'https://i.ibb.co/3sF5PcH/Monochrome-Wolf-Mascot-e-Sports-Gaming-Logo-2.pnghttps://telegra.ph/file/cce9ab4551f7150f1970d.jpg' //Main Thumbnail
global.thumb2 = 'https://i.ibb.co/3sF5PcH/Monochrome-Wolf-Mascot-e-Sports-Gaming-Logo-2.png'
global.thumbbc = 'https://i.ibb.co/3sF5PcH/Monochrome-Wolf-Mascot-e-Sports-Gaming-Logo-2.png' //For broadcast
...
global.thumbdoc = 'https://i.ibb.co/3sF5PcH/Monochrome-Wolf-Mascot-e-Sports-Gaming-Logo-2.png'
